...
<div class="form-group">
EmailId : <input type="text" name="emailId"class="form-control">
</div>
<div class="form-group">
ContactNo : <input type="number" name="contactNo" class="form-control">
</div>
<div class="form-group">
Location :<select name = "location" placeholder="select Location " required="required" id="location" class="form-control" >
...
<div class="form-group">
VehicleType :<select name="vehicleType" required="required"  id="vehicleType" class="form-control">
<option></option>
...
<div class="form-group">
Vehicle Classification :<select name = "vehicleClassification" required="required" id="vehicleClassification"class="form-control" >
<option></option>
<option>Bike</option>
<option>KIA </option>
...
<div class="form-group">
Terms :<select name = "terms" required="required" id="term" onchange="findPrice()" class="form-control" >
<option></option>
<option>1 day</option>
<option>7 Day </option>
...
<div class="form-group">
Price:<input type="text" name="price" id="price" class="form-control" readonly="readonly"> 
</div>
<div class="form-group">
		Discount:<input type="text" name="discount" id="discount" class="form-control" readonly="readonly">
</div>
<div class="form-group">
Total Amount:<input type="number" name="totalAmount" class="form-control" id="totalAmount" readonly="readonly">
</div>
<div>
 <label><input type="checkbox"> I Agreed</label>
</div>
<div>
