...
<body>
	...
	<nav class="navbar navbar-light" style="background-color: black;">
  		...
  		<div class="nav navbar-nav navbar-right">
  			<a href="Admin.jsp"><button type="button" class="btn btn-light">LogOut</button></a>
  			<p class="navbar-text" style="color: white; font-size: 20px; font-family:serif;">Admin , ${dto.adminName}</p>
  		</div>
	</nav>
	
	<div class="container">
  <div class="center">
	<a href="Information.jsp"><button>ParkingInfo</button></a>
	<a href="InformationView.jsp"><button>View</button></a>
	</div>
	</div>
