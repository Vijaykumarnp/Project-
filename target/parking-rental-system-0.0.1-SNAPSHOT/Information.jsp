...
Location :<select name = "location" placeholder="select Location " required="required" >
<option></option>
...
VehicleType :<select name="vehicleType" required="required" >
<option></option>
...
Vehicle Classification :<select name = "vehicleClassification" required="required" >
<option></option>
<option>Bike</option>
<option>KIA </option>
...
Terms :<select name = "terms" required="required" >
<option></option>
<option>1 day</option>
<option>7 Day </option>
...
Price :<input name="price" type="number" id="price" onblur="priceValidation()" ><br>
<span id="prices" style="color: red;"></span>

Discount :<input name="discount" type="text" id="discount" onblur="discountValidation()"><br>
